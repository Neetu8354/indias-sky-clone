...
const Casino = () => {
  useEffect(() => {
    applySeo({
      title: "Live Casino India 2026 | Andar Bahar, Teen Patti, Aviator | Skyexchhub",
      description:
        "Play live casino games in India on Skyexchhub — Andar Bahar, Teen Patti, Aviator, Roulette, Dragon Tiger and 1000+ titles. INR deposits, instant withdrawal, 24x7 support.",
      canonical: "https://skyexchhub.live/casino",
      keywords:
        "live casino india, andar bahar online, teen patti, aviator game, dragon tiger, online sports gaming platform, skyexchhub online platform, mobile friendly sports betting platforms",
      jsonLd: [
        {
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Live Casino on Skyexchhub",
          url: "https://skyexchhub.live/casino",
          description: "1000+ live casino games on the Skyexchhub online platform — playable in INR.",
        },
        {
          "@context": "https://schema.org",
          "@type": "BreadcrumbList",
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Casino", item: "https://skyexchhub.live/casino" },
          ],
        },
      ],
    });
        ...
        <div className="container py-12 md:py-20">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-muted-foreground text-base md:text-lg mb-7 max-w-2xl">
              Play Andar Bahar, Teen Patti, Aviator, Roulette and 1000+ live dealer games on the Skyexchhub online platform.
          ...
          {games.map((g) => (
            <div key={g.t} className="relative rounded-2xl overflow-hidden border border-border bg-gradient-card group hover:border-primary/60 transition">
              <div className="aspect-square overflow-hidden">
                <img src={g.img} alt={`Play ${g.t} live online at skyexchhub.live - online sports gaming platform`} loading="lazy" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              </div>
              {g.tag && (
